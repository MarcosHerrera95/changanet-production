...
const OfferSubmitForm = ({
  ...
  if (success) {
    return (
      <div className={`max-w-md mx-auto p-6 bg-[var(--success-bg)] border border-[var(--success-border)] rounded-lg ${className}`} role="status" aria-live="polite">
        <div className="text-center">
          <div className="w-16 h-16 bg-[var(--success-bg-light)] rounded-full flex items-center justify-center mx-auto mb-4">
          ...
          <p className="text-[var(--success-text)] text-sm">
  ...
  return (
    <div className={`max-w-md mx-auto bg-white rounded-lg shadow-md ${className}`}>
      ...
      <form onSubmit={handleSubmit} className="p-4 space-y-4">
        {/* Error message */}
        {error && (
          <div className="p-3 bg-[var(--error-bg)] border border-[var(--error-border)] rounded-lg" role="alert" aria-live="assertive">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-8 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)] focus:border-transparent text-lg font-semibold"
              placeholder="0"
              min="0"
              step="0.01"
              required
        ...
        <div>
          ...
          <textarea
            ...
            onChange={handleInputChange}
            rows={3}
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)] focus:border-transparent resize-none"
        ...
        <div className="p-3 bg-[var(--info-bg)] border border-[var(--info-border)] rounded-lg" role="note">
          <div className="flex items-start">
            <svg className="w-4 h-4 text-[var(--info)] mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
            </svg>
            <div className="text-sm text-[var(--info-text)]">
        ...
        <div className="flex flex-col space-y-3 pt-2">
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[var(--primary)] text-white py-3 px-4 rounded-md hover:bg-[var(--primary-hover)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)] focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-gray-100 text-gray-700 py-2 px-4 rounded-md hover:bg-gray-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary)] focus:ring-offset-2 disabled:opacity-50"
            aria-label="Cancelar envío de oferta"
          >
            Cancelar
          </button>
        </div>
